 ...
 */
ArrayList
arraylist_create(int8_t(*compare_func)(void*, void*)) {
 ...
 */
ArrayList
arraylist_create_heap(int8_t(*compare_func)(void*, void*)) {
 ...
 */
uint8_t
arraylist_contains(ArrayList list, void *item) {
 ...
 */
static uint32_t
quicksort_partition(ArrayList list, uint32_t left, uint32_t right) {
 ...
 */
void
arraylist_quicksort(ArrayList list, uint32_t leftIndex, uint32_t rightIndex) {
